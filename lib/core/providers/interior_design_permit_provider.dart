...
import '../drafts/interior_permit_draft_codec.dart';
import '../drafts/draft_persistence_barrel.dart';
import '../drafts/persistent_draft.dart';

/// Holds the single in-progress Interior Design application draft.
///
...
class InteriorDesignPermitProvider extends ChangeNotifier
    with PersistentDraft<InteriorPermitDraft>
  ...
  InteriorDesignPermitProvider({this.persistence});

  @override
  final DraftPersistence? persistence;

  @override
  DraftCodec<InteriorPermitDraft> get codec => const InteriorPermitDraftCodec();

  @override
  InteriorPermitDraft? get resumableDraft => hasResumableDraft ? _draft : null;

  @override
  InteriorPermitDraft beginRestoredDraft() => startNew();
  ...
  DraftSummary? get draftSummary {
    ...
    return DraftSummary(
      ...
      totalSteps: 9,
      route: '/applications/new/interior-design-permit',
