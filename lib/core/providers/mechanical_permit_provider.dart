...
import '../drafts/mechanical_permit_draft_codec.dart';
import '../drafts/draft_persistence_barrel.dart';
import '../drafts/persistent_draft.dart';

/// Holds the single in-progress Mechanical application draft.
///
...
class MechanicalPermitProvider extends ChangeNotifier
    with PersistentDraft<MechanicalPermitDraft>
  ...
  MechanicalPermitProvider({this.persistence});

  @override
  final DraftPersistence? persistence;

  @override
  DraftCodec<MechanicalPermitDraft> get codec =>
      const MechanicalPermitDraftCodec();

  @override
  MechanicalPermitDraft? get resumableDraft =>
      hasResumableDraft ? _draft : null;

  @override
  MechanicalPermitDraft beginRestoredDraft() => startNew();
  ...
  DraftSummary? get draftSummary {
    ...
    return DraftSummary(
      ...
      totalSteps: 9,
      route: '/applications/new/mechanical-permit',
