...
import '../drafts/architectural_permit_draft_codec.dart';
import '../drafts/draft_persistence_barrel.dart';
import '../drafts/persistent_draft.dart';

/// Holds the single in-progress Architectural application draft.
///
...
class ArchitecturalPermitProvider extends ChangeNotifier
    with PersistentDraft<ArchitecturalPermitDraft>
  ...
  ArchitecturalPermitProvider({this.persistence});

  @override
  final DraftPersistence? persistence;

  @override
  DraftCodec<ArchitecturalPermitDraft> get codec =>
      const ArchitecturalPermitDraftCodec();

  @override
  ArchitecturalPermitDraft? get resumableDraft =>
      hasResumableDraft ? _draft : null;

  @override
  ArchitecturalPermitDraft beginRestoredDraft() => startNew();
  ...
  DraftSummary? get draftSummary {
    ...
    return DraftSummary(
      ...
      totalSteps: 9,
      route: '/applications/new/architectural-permit',
