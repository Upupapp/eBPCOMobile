...
import '../drafts/demolition_permit_draft_codec.dart';
import '../drafts/draft_persistence_barrel.dart';
import '../drafts/persistent_draft.dart';

/// Holds the single in-progress Demolition application draft.
///
...
class DemolitionPermitProvider extends ChangeNotifier
    with PersistentDraft<DemolitionPermitDraft>
  ...
  DemolitionPermitProvider({this.persistence});

  @override
  final DraftPersistence? persistence;

  @override
  DraftCodec<DemolitionPermitDraft> get codec =>
      const DemolitionPermitDraftCodec();

  @override
  DemolitionPermitDraft? get resumableDraft =>
      hasResumableDraft ? _draft : null;

  @override
  DemolitionPermitDraft beginRestoredDraft() => startNew();
  ...
  DraftSummary? get draftSummary {
    ...
    return DraftSummary(
      ...
      totalSteps: 9,
      route: '/applications/new/demolition-permit',
