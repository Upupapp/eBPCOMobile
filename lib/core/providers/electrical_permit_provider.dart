...
import '../drafts/electrical_permit_draft_codec.dart';
import '../drafts/draft_persistence_barrel.dart';
import '../drafts/persistent_draft.dart';

/// Holds the single in-progress Electrical application draft.
///
...
class ElectricalPermitProvider extends ChangeNotifier
    with PersistentDraft<ElectricalPermitDraft>
  ...
  ElectricalPermitProvider({this.persistence});

  @override
  final DraftPersistence? persistence;

  @override
  DraftCodec<ElectricalPermitDraft> get codec =>
      const ElectricalPermitDraftCodec();

  @override
  ElectricalPermitDraft? get resumableDraft =>
      hasResumableDraft ? _draft : null;

  @override
  ElectricalPermitDraft beginRestoredDraft() => startNew();
