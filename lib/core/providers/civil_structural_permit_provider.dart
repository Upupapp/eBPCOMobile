...
import '../drafts/civil_structural_permit_draft_codec.dart';
import '../drafts/draft_persistence_barrel.dart';
import '../drafts/persistent_draft.dart';

/// Holds the single in-progress Civil / Structural application draft.
///
...
class CivilStructuralPermitProvider extends ChangeNotifier
    with PersistentDraft<CivilStructuralPermitDraft>
  ...
  CivilStructuralPermitProvider({this.persistence});

  @override
  final DraftPersistence? persistence;

  @override
  DraftCodec<CivilStructuralPermitDraft> get codec =>
      const CivilStructuralPermitDraftCodec();

  @override
  CivilStructuralPermitDraft? get resumableDraft =>
      hasResumableDraft ? _draft : null;

  @override
  CivilStructuralPermitDraft beginRestoredDraft() => startNew();
  ...
  bool get hasResumableDraft =>
      _draft != null &&
      _draft!.status == CivilStructuralPermitDraftStatus.draft;
