...
import '../drafts/renovation_permit_draft_codec.dart';
import '../drafts/draft_persistence_barrel.dart';
import '../drafts/persistent_draft.dart';

/// Holds the single in-progress Renovation application draft.
///
...
class RenovationPermitProvider extends ChangeNotifier
    with PersistentDraft<RenovationPermitDraft>
  ...
  RenovationPermitProvider({this.persistence});

  @override
  final DraftPersistence? persistence;

  @override
  DraftCodec<RenovationPermitDraft> get codec =>
      const RenovationPermitDraftCodec();

  @override
  RenovationPermitDraft? get resumableDraft =>
      hasResumableDraft ? _draft : null;

  @override
  RenovationPermitDraft beginRestoredDraft() => startNew();
