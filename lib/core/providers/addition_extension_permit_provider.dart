...
import '../drafts/addition_extension_permit_draft_codec.dart';
import '../drafts/draft_persistence_barrel.dart';
import '../drafts/persistent_draft.dart';

/// Holds the single in-progress Addition / Extension application draft.
///
...
class AdditionExtensionPermitProvider extends ChangeNotifier
    with PersistentDraft<AdditionExtensionPermitDraft>
  ...
  AdditionExtensionPermitProvider({this.persistence});

  @override
  final DraftPersistence? persistence;

  @override
  DraftCodec<AdditionExtensionPermitDraft> get codec =>
      const AdditionExtensionPermitDraftCodec();

  @override
  AdditionExtensionPermitDraft? get resumableDraft =>
      hasResumableDraft ? _draft : null;

  @override
  AdditionExtensionPermitDraft beginRestoredDraft() => startNew();
