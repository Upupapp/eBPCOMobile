...
import '../drafts/plumbing_permit_draft_codec.dart';
import '../drafts/draft_persistence_barrel.dart';
import '../drafts/persistent_draft.dart';

/// Holds the single in-progress Plumbing application draft.
///
...
class PlumbingPermitProvider extends ChangeNotifier
    with PersistentDraft<PlumbingPermitDraft>
  ...
  PlumbingPermitProvider({this.persistence});

  @override
  final DraftPersistence? persistence;

  @override
  DraftCodec<PlumbingPermitDraft> get codec => const PlumbingPermitDraftCodec();

  @override
  PlumbingPermitDraft? get resumableDraft => hasResumableDraft ? _draft : null;

  @override
  PlumbingPermitDraft beginRestoredDraft() => startNew();
  ...
  DraftSummary? get draftSummary {
    ...
    return DraftSummary(
      ...
      totalSteps: 9,
      route: '/applications/new/plumbing-permit',
