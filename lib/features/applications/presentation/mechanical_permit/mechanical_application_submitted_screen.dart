...
class MechanicalApplicationSubmittedScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ApplicationSubmittedView(
      headline: 'Mechanical Application Submitted!',
      body:
          'Your Mechanical Permit application has been submitted for '
      ...
      facts: [
        (
          ...
          value: CanonicalPermitType.mechanicalPermit.wire,
        ),
        (
        ...
        (label: 'Certificate of Operation Status', value: 'Not Yet Applicable'),
