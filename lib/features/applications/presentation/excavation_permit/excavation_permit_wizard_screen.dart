...
import '../../../../core/drafts/excavation_permit_draft_codec.dart';
...
class _ExcavationPermitWizardScreenState
  ...
  static const List<_StepMeta> _stepMeta = [
    ...
    _StepMeta(
      ...
      subtitle:
          'Provide the citizen details for the Excavation & Ground Preparation Permit.',
    ),
    _StepMeta(
  ...
  Future<void> _handleSubmit() async {
    ...
    final application = await submitPermitApplication(
      ...
      form: permitFormPayload(const ExcavationPermitDraftCodec(), _draft),
      ...
      documents: permitDocuments(const ExcavationPermitDraftCodec(), _draft),
