...
import '../../../../core/drafts/architectural_permit_draft_codec.dart';
...
class _ArchitecturalPermitWizardScreenState
  ...
  static const List<_StepMeta> _stepMeta = [
    ...
    _StepMeta(
      ...
      subtitle:
          'Provide the citizen address and location of the architectural work.',
    ),
    _StepMeta(
  ...
  Future<void> _handleSubmit() async {
    ...
    final application = await submitPermitApplication(
      ...
      form: permitFormPayload(const ArchitecturalPermitDraftCodec(), _draft),
      ...
      documents: permitDocuments(const ArchitecturalPermitDraftCodec(), _draft),
        ...
        body: SafeArea(
          child: Column(
            children: [
              ...
              ReattachNotice(
                documents: context
                    .watch<ArchitecturalPermitProvider>()
                    .documentsToReattach,
                onDismiss: () => context
                    .read<ArchitecturalPermitProvider>()
