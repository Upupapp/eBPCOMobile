...
import '../../../../core/drafts/plumbing_permit_draft_codec.dart';
...
class _PlumbingPermitWizardScreenState
  ...
  static const List<_StepMeta> _stepMeta = [
    ...
    _StepMeta(
      ...
      subtitle:
          'Provide the citizen address and location of the plumbing work.',
    ),
    _StepMeta(
  ...
  Future<void> _handleSubmit() async {
    ...
    final application = await submitPermitApplication(
      ...
      form: permitFormPayload(const PlumbingPermitDraftCodec(), _draft),
      ...
      documents: permitDocuments(const PlumbingPermitDraftCodec(), _draft),
      ...
      permitTypeLabel: CanonicalPermitType.plumbingPermit.wire,
        ...
        body: SafeArea(
          child: Column(
            children: [
              ...
              ReattachNotice(
                documents: context
                    .watch<PlumbingPermitProvider>()
                    .documentsToReattach,
                onDismiss: () => context
                    .read<PlumbingPermitProvider>()
