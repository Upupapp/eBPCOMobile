...
import '../../../../core/drafts/electronics_permit_draft_codec.dart';
...
class _ElectronicsPermitWizardScreenState
  ...
  Future<void> _handleSubmit() async {
    ...
    final application = await submitPermitApplication(
      ...
      form: permitFormPayload(const ElectronicsPermitDraftCodec(), _draft),
      ...
      documents: permitDocuments(const ElectronicsPermitDraftCodec(), _draft),
      ...
      permitTypeLabel: CanonicalPermitType.electronicsPermit.wire,
        ...
        body: SafeArea(
          child: Column(
            children: [
              ...
              ReattachNotice(
                documents: context
                    .watch<ElectronicsPermitProvider>()
                    .documentsToReattach,
                onDismiss: () => context
                    .read<ElectronicsPermitProvider>()
