...
import '../../../../core/drafts/addition_extension_permit_draft_codec.dart';
...
class _AdditionExtensionPermitWizardScreenState
  ...
  Future<void> _handleSubmit() async {
    ...
    final application = await submitPermitApplication(
      ...
      // The attachments the citizen added. Passed since 31 August 2026; before
      // that submitPermitApplication hardcoded an empty list and none of them
      // were ever uploaded.
        ...
        body: SafeArea(
          child: Column(
            children: [
              ...
              ReattachNotice(
                documents: context
                    .watch<AdditionExtensionPermitProvider>()
                    .documentsToReattach,
                onDismiss: () => context
                    .read<AdditionExtensionPermitProvider>()
