...
class SanitaryPlumbingApplicationSubmittedScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ApplicationSubmittedView(
      headline: 'Sanitary / Plumbing Application Submitted!',
      body:
          'Your Sanitary / Plumbing Permit application has been submitted for '
      ...
      facts: [
        (label: 'Application Type', value: 'Sanitary / Plumbing Permit'),
