...
import '../../../../core/drafts/sanitary_permit_draft_codec.dart';
...
class _SanitaryPlumbingPermitWizardScreenState
  ...
  static const List<_StepMeta> _stepMeta = [
    ...
    _StepMeta(
      ...
      subtitle:
          'Provide the citizen address and location of the sanitary or plumbing work.',
    ),
    _StepMeta(
      title: 'Scope of Work',
      subtitle:
  ...
  Future<void> _handleSubmit() async {
    ...
    final application = await submitPermitApplication(
      ...
      form: permitFormPayload(const SanitaryPermitDraftCodec(), _draft),
      ...
      documents: permitDocuments(const SanitaryPermitDraftCodec(), _draft),
        ...
        body: SafeArea(
          child: Column(
            children: [
              ...
              ReattachNotice(
                documents: context
                    .watch<SanitaryPlumbingPermitProvider>()
                    .documentsToReattach,
                onDismiss: () => context
                    .read<SanitaryPlumbingPermitProvider>()
