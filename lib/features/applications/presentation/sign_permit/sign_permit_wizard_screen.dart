...
import '../../../../core/drafts/sign_permit_draft_codec.dart';
...
class _SignPermitWizardScreenState extends State<SignPermitWizardScreen> {
  ...
  static const List<_StepMeta> _stepMeta = [
    ...
    _StepMeta(
      ...
      subtitle: 'Provide the citizen details for the Sign Permit.',
    ),
    _StepMeta(
    ...
    _StepMeta(
      ...
      subtitle: 'Confirm the citizen and building owner information.',
    ),
    _StepMeta(
  ...
  Future<void> _handleSubmit() async {
    ...
    final application = await submitPermitApplication(
      ...
      documents: permitDocuments(const SignPermitDraftCodec(), _draft),
      ...
      permitTypeLabel: CanonicalPermitType.signPermit.wire,
          ...
          child: Column(
            children: [
              WizardProgressHeader(
                intro: 'Complete your Sign Permit application step by step.',
