...
import '../../../../core/drafts/fencing_permit_draft_codec.dart';
...
class _FencingPermitWizardScreenState extends State<FencingPermitWizardScreen> {
  ...
  Future<void> _handleSubmit() async {
    ...
    final application = await submitPermitApplication(
      ...
      documents: permitDocuments(const FencingPermitDraftCodec(), _draft),
          ...
          child: Column(
            children: [
              WizardProgressHeader(
                intro: 'Complete your Fencing Permit application step by step.',
