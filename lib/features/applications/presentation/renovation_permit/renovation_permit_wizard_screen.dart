...
import '../../../../core/drafts/renovation_permit_draft_codec.dart';
...
class _RenovationPermitWizardScreenState
  ...
  Future<void> _handleSubmit() async {
    ...
    final application = await submitPermitApplication(
      ...
      form: permitFormPayload(const RenovationPermitDraftCodec(), _draft),
      ...
      documents: permitDocuments(const RenovationPermitDraftCodec(), _draft),
      ...
      location: constructionLocationLine(
        lot: _draft.renovationLocation.lotNumber,
        block: _draft.renovationLocation.blockNumber,
        street: _draft.renovationLocation.street,
        barangay: _draft.renovationLocation.barangay,
        city: _draft.renovationLocation.city,
      ),
        ...
        body: SafeArea(
          child: Column(
            children: [
              ...
              ReattachNotice(
                documents: context
                    .watch<RenovationPermitProvider>()
                    .documentsToReattach,
                onDismiss: () => context
                    .read<RenovationPermitProvider>()
