...
import '../../../../core/drafts/civil_structural_permit_draft_codec.dart';
...
class _CivilStructuralPermitWizardScreenState
  ...
  Future<void> _handleSubmit() async {
    ...
    final application = await submitPermitApplication(
      ...
      form: permitFormPayload(const CivilStructuralPermitDraftCodec(), _draft),
      ...
      permitTypeLabel: CanonicalPermitType.civilStructuralPermit.wire,
        ...
        body: SafeArea(
          child: Column(
            children: [
              ...
              ReattachNotice(
                documents: context
                    .watch<CivilStructuralPermitProvider>()
                    .documentsToReattach,
                onDismiss: () => context
                    .read<CivilStructuralPermitProvider>()
