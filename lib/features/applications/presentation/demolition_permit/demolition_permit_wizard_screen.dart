...
import '../../../../core/drafts/demolition_permit_draft_codec.dart';
...
class _DemolitionPermitWizardScreenState
  ...
  Future<void> _handleSubmit() async {
    ...
    final application = await submitPermitApplication(
      ...
      form: permitFormPayload(const DemolitionPermitDraftCodec(), _draft),
      ...
      documents: permitDocuments(const DemolitionPermitDraftCodec(), _draft),
        ...
        body: SafeArea(
          child: Column(
            children: [
              ...
              ReattachNotice(
                documents: context
                    .watch<DemolitionPermitProvider>()
                    .documentsToReattach,
                onDismiss: () => context
                    .read<DemolitionPermitProvider>()
