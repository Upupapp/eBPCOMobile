...
import '../../../../core/drafts/electrical_permit_draft_codec.dart';
...
class _ElectricalPermitWizardScreenState
  ...
  static const List<_StepMeta> _stepMeta = [
    ...
    _StepMeta(
      ...
      subtitle:
          'Provide the citizen address and location of the electrical work.',
    ),
    _StepMeta(
      title: 'Scope of Work',
  ...
  Future<void> _handleSubmit() async {
    ...
    final application = await submitPermitApplication(
      ...
      form: permitFormPayload(const ElectricalPermitDraftCodec(), _draft),
      ...
      documents: permitDocuments(const ElectricalPermitDraftCodec(), _draft),
        ...
        body: SafeArea(
          child: Column(
            children: [
              ...
              ReattachNotice(
                documents: context
                    .watch<ElectricalPermitProvider>()
                    .documentsToReattach,
                onDismiss: () => context
                    .read<ElectricalPermitProvider>()
