...
/// Fire Safety Evaluation Clearance (FSEC) application wizard — a 4-step flow built from the
...
/// a bill.
class FsecClearanceWizardScreen extends StatefulWidget {
  const FsecClearanceWizardScreen({super.key});

  @override
  State<FsecClearanceWizardScreen> createState() =>
      _FsecClearanceWizardScreenState();
}

class _FsecClearanceWizardScreenState extends State<FsecClearanceWizardScreen> {
  ...
  Future<void> _handleSubmit() async {
    ...
    final application = await submitPermitApplication(
      ...
      documents: permitDocuments(const FsecPermitDraftCodec(), _draft),
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text('Fire Safety Evaluation Clearance'),
          leading: IconButton(
          ...
          child: Column(
            children: [
              WizardProgressHeader(
                intro:
                    'Complete your FSEC application step by step. This is '
              ...
              ReattachNotice(
                documents: context
                    .watch<FsecPermitProvider>()
                    .documentsToReattach,
                onDismiss: () => context
                    .read<FsecPermitProvider>()
